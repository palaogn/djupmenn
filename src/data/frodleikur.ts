...
export const frodleikur: FrodleikurEntry[] = [
  ...
  {
    "id": 30,
    "slug": "stjorn-djupmanna",
    "title": "Stjórn Djúpmanna",
    "paragraphs": [
      "Stjórn Félags Djúpmanna er kosin árlega á aðalfundi félagsins.",
      "Formaður: Jórunn Silla Geirsdóttir frá Skálavík í Mjóafirði",
      "Gjaldkeri: Daníel Helgasson frá Odda í Ögurvík",
      "Ritari: Gunnar Þorgeir Gunnarsson frá Heydal í Mjóafirði",
      "Meðstjórnandi: Jón Ebbi Halldórsson frá Eyri í Mjóafirði",
      "Meðstjórnandi: Halldór Halldórsson frá Ögri í Ögurvík",
      "Varamaður: Ragnheiður Baldursdóttir frá Vigur",
      "Varamaður: Níls Daníelsson frá Odda í Ögurvík"
    ]
  },
  {
    "id": 26,
